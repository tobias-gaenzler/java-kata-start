...
public class FizzBuzzTest {
    ...
    public void shouldReturnNumberIfNotDivisibleBy3Or5(Integer number) {
    ...
    public void shouldReturnFizzForDivisibleBy3AndNot5(Integer number) {
        String result = new FizzBuzz().translateNumberToFizzBuzz(number);
    ...
    public void shouldReturnBuzzForDivisibleBy5AndNot3(Integer number) {
        String result = new FizzBuzz().translateNumberToFizzBuzz(number);
